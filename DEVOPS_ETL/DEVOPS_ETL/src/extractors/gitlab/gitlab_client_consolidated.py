...
class GitLabClient(BaseExtractor):
    ...
    def __init__(self, gitlab_config: Dict[str, Any]) -> None:
        ...
        """
        # Initialiser BaseExtractor en premier
        super().__init__()
    ...
    def establish_connection(self) -> bool:
        ...
        try:
            ...
            # Tester la connexion
            self._current_user_info = self._gitlab_client.user.get().asdict()
            self._connection_status = True
            
            self._logger.info(
                SUCCESS_MESSAGES["CONNECTION_SUCCESS"].format(
                    user=self._current_user_info.get("name", "Unknown"),
    ...
    def test_connection(self) -> bool:
        """
        Méthode de compatibilité pour test_connection.
